...
<head>
    <meta charset="UTF-8">
    <title>Welcome to new jenkins</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css">
</head>
<body>
  <div class="jumbotron" style="background-color:white">
     <h1 class="text-center">Welcome to Devops</h1>
      ...
      <h2 class="text-center">Welcome to classes</h2>
	  <h3 class="text-center">Welcome to  the devops classes</h3>
